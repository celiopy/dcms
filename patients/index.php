...
?>
    <main class="main">
        <div class="flex items-center gap-300" style="margin-block-end: 2rem;">
            <i class="mi mi-patient" style="display: flex; align-items: center; justify-content: center; width: 1.5em; height: 1.5em; border: 1px solid; border-radius: 100%; font-size: 2rem;"></i>
            <h2>Pacientes</h2>
            <div style="margin-inline-start: auto;">
                <button><i class="mi mi-add-circle"></i> Criar paciente</button>
            </div>
        </div>
